    ...
    export const MillionPath: React.FC<MillionPathProps> = ({ setGlobalScore, onClose }) => {
        ...
        if (level <= 3) return 0.50; // Puertas baratas (Anzuelo)
        if (level <= 5) return 0.65; // Puertas medias
        if (level === 6) return 0.85; // Penúltima puerta
        return 1.25;                 // Puerta del Final Boss
    };
