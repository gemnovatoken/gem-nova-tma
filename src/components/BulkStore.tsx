...
// 1. Importamos el botón de Wallet
    ...
    return (
        <div className="cyber-bg" style={{ minHeight: '100%', paddingBottom: '120px', paddingTop: '20px' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '40px', position: 'relative', zIndex: 2 }}>
                ...
                {/* 🛡️ BOTÓN WALLET INTEGRADO (Pequeño y a la derecha) */}
                <div style={{ position: 'absolute', right: '20px', top: '0', transform: 'scale(0.85)', transformOrigin: 'right top' }}>
                    <TonConnectButton />
                </div>
